...
function Form() {
  ...
  return (
    <div className="w-full max-w-sm mx-auto rounded-2xl p-6">
      ...
      {step === "verify" ? (
        <div key="verify" className="fade-in">
          {/* Back */}
          <button
          ...
          <button
            ...
            className="w-full bg-white border border-heading/10 text-heading text-sm font-semibold py-3 rounded-lg mb-6 mt-2 hover:bg-[#f4ece4]/50 transition-colors"
          >
            Confirm email
          </button>
        ...
        <div key="auth" className="fade-in">
          {/* Toggle */}
          ...
          <div key={mode} className="fade-in">
            ...
            <button
              ...
              className="w-full bg-heading text-white text-sm font-medium py-3 rounded-lg mb-4 hover:opacity-90 transition-opacity"
            >
          ...
          {/* Google */}
          <button className="w-full flex items-center justify-center gap-2 border border-grey/20 text-sm font-medium py-3 rounded-lg mb-3 hover:bg-[#f4ece4]/50 transition-colors">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
          ...
          {/* LinkedIn */}
          <button className="w-full flex items-center justify-center gap-2 border border-grey/20 text-sm font-medium py-3 rounded-lg hover:bg-[#f4ece4]/50 transition-colors">
            <svg
              width="18"
              height="18"
              viewBox="0 0 24 24"
